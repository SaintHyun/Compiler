...
let rec trans_exp sym_tab arg_tab e = 
  ...
  | Add (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        ...
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, AddOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, AddOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | Sub (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, SubOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      let inst1, r1 = trans_exp sym_tab arg_tab exp1 in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, SubOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | Mul (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, MulOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      let inst1, r1 = trans_exp sym_tab arg_tab exp1 in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, MulOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | Div (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, DivOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      let inst1, r1 = trans_exp sym_tab arg_tab exp1 in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, DivOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | Neg (exp) ->
    ...
    | _ ->
      ...
      let r2 = create_register_name() in
      let tmp_inst = inst @ [UnOp (r2, NegOp, reg_to_opr r1)] in
      (tmp_inst, r2)
    )
  ...
  | Equal (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, EqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    ...
    | ConstBool i ->
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, EqOp, Imm (ImmBool r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    ...
    | _ -> 
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, EqOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | ConstBool i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, EqOp, reg_to_opr r1, Imm (ImmBool r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | NotEq (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, NeqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    ...
    | ConstBool i ->
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, NeqOp, Imm (ImmBool r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    ...
    | _ -> 
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, NeqOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | ConstBool i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, NeqOp, reg_to_opr r1, Imm (ImmBool r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | LessEq (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3,LeqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      let inst1, r1 = trans_exp sym_tab arg_tab exp1 in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, LeqOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | LessThan (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, LtOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      let inst1, r1 = trans_exp sym_tab arg_tab exp1 in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, LtOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | GreaterEq (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, GeqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      let inst1, r1 = trans_exp sym_tab arg_tab exp1 in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, GeqOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | GreaterThan (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
        let tmp_inst = inst2 @ [BinOp (r3, GtOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, r3)
      )
    | _ -> 
      let inst1, r1 = trans_exp sym_tab arg_tab exp1 in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        let r3 = create_register_name() in
        (inst1 @ [BinOp (r3, GtOp, reg_to_opr r1, Imm (ImmInt r2))], r3)
      | _ ->
        let inst2, r2 = trans_exp sym_tab arg_tab exp2 in
        let r3 = create_register_name() in
  ...
  | Not (exp) ->
    ...
    | _ ->
      let inst, r1 = trans_exp sym_tab arg_tab exp in
      let r2 = create_register_name() in
      let tmp_inst = inst @ [UnOp (r2, NotOp, reg_to_opr r1)] in
      (tmp_inst, r2)
    )
...
let rec trans_var sym_tab arg_tab e var = 
  ...
  | Add (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        ...
        let tmp_inst = inst2 @ [BinOp (var, AddOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, AddOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, AddOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | Sub (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, SubOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      let inst1, r1 = trans_var sym_tab arg_tab exp1 var in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, SubOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, SubOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | Mul (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, MulOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      let inst1, r1 = trans_var sym_tab arg_tab exp1 var in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, MulOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, MulOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | Div (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, DivOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      let inst1, r1 = trans_var sym_tab arg_tab exp1 var in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, DivOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, DivOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | Neg (exp) ->
    ...
    | _ ->
      ...
      let tmp_inst = inst @ [UnOp (var, NegOp, reg_to_opr r1)] in
      (tmp_inst, var)
    )
  ...
  | Equal (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, EqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    ...
    | ConstBool i ->
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, EqOp, Imm (ImmBool r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    ...
    | _ -> 
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, EqOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | ConstBool i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, EqOp, reg_to_opr r1, Imm (ImmBool r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, EqOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | NotEq (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, NeqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    ...
    | ConstBool i ->
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, NeqOp, Imm (ImmBool r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    ...
    | _ -> 
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, NeqOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | ConstBool i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, NeqOp, reg_to_opr r1, Imm (ImmBool r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, NeqOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | LessEq (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var,LeqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      let inst1, r1 = trans_var sym_tab arg_tab exp1 var in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, LeqOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, LeqOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | LessThan (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, LtOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      let inst1, r1 = trans_var sym_tab arg_tab exp1 var in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, LtOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, LtOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | GreaterEq (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, GeqOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      let inst1, r1 = trans_var sym_tab arg_tab exp1 var in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, GeqOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, GeqOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | GreaterThan (exp1, exp2) ->
    ...
    | ConstInt i -> 
      ...
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst2 @ [BinOp (var, GtOp, Imm (ImmInt r1), reg_to_opr r2)] in
        (tmp_inst, var)
      )
    | _ -> 
      let inst1, r1 = trans_var sym_tab arg_tab exp1 var in
      ...
      | ConstInt i2 -> 
        let r2 = i2 in
        (inst1 @ [BinOp (var, GtOp, reg_to_opr r1, Imm (ImmInt r2))], var)
      | _ ->
        let inst2, r2 = trans_var sym_tab arg_tab exp2 var in
        let tmp_inst = inst1 @ inst2 @ [BinOp (var, GtOp, reg_to_opr r1, reg_to_opr r2)] in
        (tmp_inst, var)
      )
    )
  ...
  | Not (exp) ->
    ...
    | _ ->
      let inst, r1 = trans_var sym_tab arg_tab exp var in
      let tmp_inst = inst @ [UnOp (var, NotOp, reg_to_opr r1)] in
      (tmp_inst, var)
    )
        ...
        | Assign (lvar, exp) ->
          ...
          | LVar str -> 
            if SymbolMap.mem str sym_tab = true then
              ...
              (irs @ tmp_ir @ [Store (reg_to_opr result, reg)], sym_tab, arg_tab)
            else
              (match exp with
              | Var vname ->
